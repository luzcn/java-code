...
/**
 * design a function such that return the total distance from this node to any other nodes 给的树 是 多枝树
 * n-ary tree 每个edge distance 为1. 如 Asssume function name as D:   then D(A) = 1+1+1+1+2+2. D(B) =
 * 1+2+2+2+3+3 = 13
 *
 * A ／ |  |  \ B      C  D  E |         \
 *
