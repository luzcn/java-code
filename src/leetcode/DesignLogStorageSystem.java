 ...
 * timestamps are within the range from start to end.
 *
 * Start and end all have the same format as timestamp. However, granularity means the time level
 * for consideration.
 *
 * For example, start = "2017:01:01:23:59:59", end = "2017:01:02:23:59:59", granularity = "Day", it
 * means that we need to find the logs within the range from Jan. 1st 2017 to Jan. 2nd 2017.
 *
 * Example 1: put(1, "2017:01:01:23:59:59"); put(2, "2017:01:01:22:59:59"); put(3,
 * "2016:01:01:00:00:00");
 *
 ...
 * // where log 3 is left outside the range. retrieve("2016:01:01:01:01:01","2017:01:01:23:00:00","Hour");
 */
