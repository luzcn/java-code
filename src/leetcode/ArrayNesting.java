 ...
 *
 * Example 1: Input: A = [5,4,0,3,1,6,2] Output: 6 Explanation: A[0] = 5, A[1] = 4, A[2] = 0, A[3] =
 * 3, A[4] = 1, A[5] = 6, A[6] = 2.
 *
 * One of the longest S[K]: S[0] = {A[0], A[5], A[6], A[2]} = {5, 6, 2, 0} Note: N is an integer
 * within the range [1, 20,000]. The elements of A are all distinct. Each element of A is an integer
