...
public class FlattenBinaryTreeToLinkedList_114 {
  ...
  /**
   * similar to morris tree for each node "n", 1. if n has left child, 1.1 find the rightmost node
   * "r" in its left sub tree 1.2  make r.right = n.right; 1.3  make n right child point to its left
   * child i.e. n.right = n.left, n.left = null
   *
   * 2. move to right child. (either no left child, or left child has been moved to right
   * position).
   */
