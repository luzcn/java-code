 ...
 * from two different arrays (each array picks one) and calculate the distance.
 *
 * We define the distance between two integers a and b to be their absolute difference |a-b|. Your
 * task is to find the maximum distance.
 */
