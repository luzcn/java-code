 ...
 * arrays.
 *
 * a.k.a the longest common subarray, similar to longest common substring, or longest common
 * subsequence Example 1: Input: A: [1,2,3,2,1] B: [3,2,1,4,7] Output: 3 Explanation: The repeated
