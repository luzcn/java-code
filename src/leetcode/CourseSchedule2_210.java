...
//
// Thougths: use topological sort to find the dependency in DAG - topo sort is similar to dfs,
// bottom up recursive and save in a stack - topo sort only works in directed graph without cycle
///
